...
pretrained=1
pretrain_path=$3
y_attr=normalized_experimental_mt
...
do
	...
	do 
		...
		do
			python3 bigru_model_pretrain.py $1 $2_$cnt $max_seq $max_rt $min_rt $GRU_unit $embed_out $dense_feature $dropout_rate $dense_dropout $y_attr $pretrained $3
